...
| 3. Archive exact versions of external programs | Declarative spec and resolved lockfile, verified by building clean and re-running. An image too where one is needed; this project needs none (`readme-at-start.md`: no Docker). | `/pin-environment` |
