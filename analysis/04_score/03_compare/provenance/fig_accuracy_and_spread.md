...
```
result:              main/fig_accuracy_and_spread.png
...
```
result:
                     results/$COMBO/fig_accuracy_and_spread.png
                     results/$COMBO/fig_accuracy_and_spread.csv
                     results/$COMBO/fig_accuracy_and_spread_preaggregation.csv
